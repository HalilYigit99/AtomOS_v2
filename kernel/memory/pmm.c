...
MemoryRegionType mb2_mrType_to_mrType(uint32_t mb2_type) {
    ...
    default: return MemoryRegionType_UNKNOWN;
    }
}
...
MemoryRegionType efiType_to_mrType(uint32_t efi_type) {
    ...
    case 0:  return MemoryRegionType_RESERVED;
    case 1:  return MemoryRegionType_EFI_CODE; // Loader Code
    case 2:  return MemoryRegionType_EFI_DATA; // Loader Data
    case 3:  return MemoryRegionType_EFI_CODE; // Boot Services Code (ExitBootServices sonrası reclaim edilebilir)
    case 4:  return MemoryRegionType_EFI_DATA; // Boot Services Data  (ExitBootServices sonrası reclaim edilebilir)
    case 5:  return MemoryRegionType_RESERVED; // Runtime Code (reclaim edilmez)
    case 6:  return MemoryRegionType_RESERVED; // Runtime Data (reclaim edilmez)
    case 7:  return MemoryRegionType_USABLE;   // Conventional Memory
    case 8:  return MemoryRegionType_BAD_MEMORY; // Unusable
    case 9:  return MemoryRegionType_ACPI_RECLAIMABLE;
    case 10: return MemoryRegionType_ACPI_NVS;
    case 11: return MemoryRegionType_PCI_RESOURCE; // MMIO
    case 12: return MemoryRegionType_PCI_RESOURCE; // MMIO Port Space
    case 13: return MemoryRegionType_RESERVED; // PAL Code (Itanium, pratikte yok)
    case 14: return MemoryRegionType_RESERVED; // Persistent/NVDIMM, özel işleme yoksa RESERVED
    default: return MemoryRegionType_UNKNOWN;
    }
}
...
char* mrTypeToString(MemoryRegionType type) {
    switch (type) {
        case MemoryRegionType_UNKNOWN: return "UNKNOWN";
        case MemoryRegionType_NULL: return "NULL";
        case MemoryRegionType_USABLE: return "USABLE";
        case MemoryRegionType_RESERVED: return "RESERVED";
        case MemoryRegionType_EFI_CODE: return "EFI_CODE";
        case MemoryRegionType_EFI_DATA: return "EFI_DATA";
        case MemoryRegionType_ACPI_RECLAIMABLE: return "ACPI_RECLAIMABLE";
        case MemoryRegionType_ACPI_NVS: return "ACPI_NVS";
        case MemoryRegionType_BAD_MEMORY: return "BAD_MEMORY";
        case MemoryRegionType_PCI_RESOURCE: return "PCI_RESOURCE";
