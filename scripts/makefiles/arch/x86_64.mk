...
X86_64_C_OBJECTS = $(patsubst $(KERNEL_DIR)/amd64/%.c,$(BUILD_X86_64)/%.o,$(X86_64_C_SOURCES))
X86_64_ASM_OBJECTS = $(patsubst $(KERNEL_DIR)/amd64/%.asm,$(BUILD_X86_64)/%.o,$(X86_64_ASM_SOURCES))
X86_64_OBJECTS = $(X86_64_C_OBJECTS) $(X86_64_ASM_OBJECTS)

# Pattern rules for x86_64 C files
$(BUILD_X86_64)/%.o: $(KERNEL_DIR)/amd64/%.c | $(BUILD_X86_64)
	@mkdir -p $(dir $@)
	$(call log_build,Compiling x86_64 specific: $<)
	@$(CC_64) $(CFLAGS_64) -c $< -o $@

# Pattern rules for x86_64 ASM files
$(BUILD_X86_64)/%.o: $(KERNEL_DIR)/amd64/%.asm | $(BUILD_X86_64)
	@mkdir -p $(dir $@)
